...
const premium = ['380810113813970944']
...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = [`${client.guilds.size} Server`,'$help','Type $help','ExPlosive By ! Mohamad_Doleh .#6334'`${client.users.size} Members`,'!inv','By: Mohamed '];
    var i = -1;
    var j = 0;
